...
public class SolnetProgramsDataController
{
    ...
    public bool RunCreateAndSendTokensToAccount(CreateAndSendTokensPayload payload)
    {
        ...
        var associatedTokenAccount =
            AssociatedTokenAccountProgram.DeriveAssociatedTokenAccount(associatedTokenAccountOwner, mintAccountModel.Wallet.Account);

        var txBytes = new TransactionBuilder().
            SetRecentBlockHash(recentHash.Result.Value.Blockhash).
            SetFeePayer(ownerAccountModel.Wallet.Account).
